...
type node struct {
	...
	breakPos  bool           // breakpoint set by position
	breakCall bool           // breakpoint set on function call
	prog      *Program       // program this is part of, only stored on the root node
}
